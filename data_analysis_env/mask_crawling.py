...
with webdriver.Chrome(driver_path, options=options) as driver:
    ...
    for i in range(41, 51):
        ...
        if not os.path.exists('mask_data_41-50.csv'):
            data.to_csv('mask_data_41-50.csv', index=False,
                        mode='w', encoding='utf-8-sig')
        else:
            data.to_csv('mask_data_41-50.csv', index=False, mode='a',
